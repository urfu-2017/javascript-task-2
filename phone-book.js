...
const set = (phone, name, email, rewrite) =>
    name && PHONE_PATTERN.test(phone) && (rewrite || !phoneBook.has(phone))
...
exports.findAndRemove = query => search(query)
    .filter(([phone]) => phoneBook.delete(phone)).length;
